...
protected:
    inline static std::shared_ptr<tatami::NumericMatrix> dense_mod, sparse_mod, mixed_mod, ref;
...
protected:
    ...
    static void assemble() {
        ...
        mixed_mod = tatami::make_DelayedBinaryIsometricOp(sparse_left0, dense_right0, op);

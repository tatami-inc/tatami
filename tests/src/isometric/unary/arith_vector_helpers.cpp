...
//    EXPECT_FALSE(sparse_mod->prefer_rows());
//
//    tatami_test::test_simple_column_access<true>(dense_mod.get(), ref.get());
//    tatami_test::test_simple_column_access<true>(sparse_mod.get(), ref.get());
//
//    tatami_test::test_simple_row_access<true>(dense_mod.get(), ref.get());
//    tatami_test::test_simple_row_access<true>(sparse_mod.get(), ref.get());
//}
//
//INSTANTIATE_TEST_SUITE_P(
//    ArithVector,
...
//    {
//        size_t FIRST = interval_info[0] * nrow, LAST = interval_info[1] * nrow;
//        tatami_test::test_sliced_column_access<true>(dense_mod.get(), ref.get(), FIRST, LAST);
//        tatami_test::test_sliced_column_access<true>(sparse_mod.get(), ref.get(), FIRST, LAST);
//    }
//
//    {
//        size_t FIRST = interval_info[0] * ncol, LAST = interval_info[1] * ncol;
//        tatami_test::test_sliced_row_access<true>(dense_mod.get(), ref.get(), FIRST, LAST);
//        tatami_test::test_sliced_row_access<true>(sparse_mod.get(), ref.get(), FIRST, LAST);
//    }
//}
//
//INSTANTIATE_TEST_SUITE_P(
...
//    {
//        size_t FIRST = interval_info[0] * nrow, STEP = interval_info[1] * nrow;
//        tatami_test::test_indexed_column_access<true>(dense_mod.get(), ref.get(), FIRST, STEP);
//        tatami_test::test_indexed_column_access<true>(sparse_mod.get(), ref.get(), FIRST, STEP);
//    }
//
//    {
//        size_t FIRST = interval_info[0] * ncol, STEP = interval_info[1] * ncol;
//        tatami_test::test_indexed_row_access<true>(dense_mod.get(), ref.get(), FIRST, STEP);
//        tatami_test::test_indexed_row_access<true>(sparse_mod.get(), ref.get(), FIRST, STEP);
//    }
//}
//
//INSTANTIATE_TEST_SUITE_P(
...
//    EXPECT_TRUE(sparse_mod->sparse());
//
//    tatami_test::test_full_access(params, dense_mod.get(), dense.get(), true, 1);
//    tatami_test::test_full_access(params, sparse_mod.get(), sparse.get(), true, 1); 
//
...
//        EXPECT_TRUE(sparse_mod->sparse());
//
//        tatami_test::test_full_access(params, dense_mod.get(), &ref, true, 1);
//        tatami_test::test_full_access(params, sparse_mod.get(), &ref, true, 1); 
//

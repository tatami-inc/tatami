 ...
 */
template<typename OutputValue_, typename Index_, class Operation_, typename InputValue_ = OutputValue_>
...
using DelayedIsometricOperation = DelayedUnaryIsometricOperation<OutputValue_, Index_, Operation_>;
/**
 * @endcond
 */

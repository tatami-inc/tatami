...
public:
    ...
    virtual sparse_range<T, IDX> get_sparse_row(size_t i, T* outv, IDX* outi, size_t start=0, size_t end=-1, workspace* work=NULL) const {
    ...
    virtual sparse_range<T, IDX> get_sparse_column(size_t i, T* outv, IDX* outi, size_t start=0, size_t end=-1, workspace* work=NULL) const {
    ...
    sparse_range<T, IDX> get_sparse_row(size_t i, T* out_values, IDX* out_indices, workspace* work) const {
        return get_sparse_row(i, out_values, out_indices, 0, this->ncol(), work);
    }

    sparse_range<T, IDX> get_sparse_column(size_t i, T* out_values, IDX* out_indices, workspace* work) const {
